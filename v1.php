 ...
 <div class=" w3-light-grey w3-padding-64 w3-container">
    ...
    <br>  
          <form method="post" action="cart1.php">
            <img src="img/1.png" alt="Filipino sa Iba't Ibang Disiplina" class="fil-size" style="display: inline-block;">
            <h6>Filipino sa Iba't Ibang Disiplina</h6><h6><b>Stock:</b> <?php echo $row['stock']; ?></h6><h6>₱ 270.00</h6>
